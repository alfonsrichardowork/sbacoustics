        ...
        />
            {data && 
                <>
                    <div className="block md:flex">
                        ...
                        <div className="md:flex md:w-1/2 justify-center md:h-1/2 block w-full h-full">
                            <div className="flex-col w-full md:flex hidden pr-10">
                                <div className="w-full h-full pb-4">
                                    <SwiperCarouselCoverandCatalogues name={data.name} cover={data.coverImg} image_catalogues={data.images_Catalogues}/>
                                </div>
                                {data.drawing !== '' &&
                                ...
                                {data.kitsFinishing && data.kitsFinishing.length > 0 &&
                                    <SwiperCarouselKitsFinishing kits_finishing={data.kitsFinishing} kits_finishing_preview={data.kitsFinishingPreview??[]}/>
                                }             
                            </div>
                            <div className="w-full h-full md:hidden pb-4">
                                <SwiperCarouselOneProduct name={data.name} cover={data.coverImg} image_catalogues={data.images_Catalogues} drawing={data.drawing} graph={data.graph}/>        
                            </div>
                        ...
                        <div className="md:flex md:w-1/2 justify-center md:h-1/2 block w-full h-full">
                            <div className="flex flex-col w-full">
                                ...
                                {data.productsinKits && data.productsinKits.length > 0 &&
                                    <>
                                        <div className={`${all_desc_style} font-bold pt-4`}>
                                            <h2>{data.slug === 'dw50' ? 'Compatible Drivers:' : 'Drivers:'}</h2>
                                        </div>
                                        {data.productsinKits.map((value, index) => (
                                            <Link href={`/products/${value.href}`} key={index} className={`${all_desc_style} font-semibold flex items-center py-0`}>
                                                <div className="pr-2">
                                                   <Dot size={10} strokeWidth={10} />
                                                </div>
                                                <div className="hover:text-primary text-primary/80 underline text-sm">{value.name}</div>
                                            </Link>
                                        ))}
                                    </>
                                }
                                    ...
                                    <>
                                        ...
                                        {data.datasheet.length===1 && data.datasheet[0]?.url!=''?
                                            <div className="flex justify-start pt-8">
                                                <Link href={data.datasheet[0]?.url ?? '/'} target="_blank" className={`${all_desc_style} font-bold flex items-center hover:text-primary`}>
                                                    <div className="pr-2">
                                    ...
                                    <>
                                        ...
                                        data.frdzma.length===1 && data.frdzma[0]?.url!=''?
                                            <div className="flex justify-start pt-4">
                                                <Link href={data.frdzma[0]?.url ?? '/'} target="_blank" className={`${all_desc_style} font-bold flex items-center hover:text-primary`}>
                                                    <div className="pr-2">
                                                        {/* <Download strokeWidth={3} size={15} className="text-white"/> */}
                                ...
                                {data.models3d && data.models3d.length > 0 &&
                                    <>
                                        ...
                                        {data.models3d.length===1 && data.models3d[0]?.url!=''?
                                            <div className="flex justify-start pt-4">
                                                <Link href={data.models3d[0]?.url ?? '/'} target="_blank" className={`${all_desc_style} font-bold flex items-center hover:text-primary`}>
                                                    <div className="pr-2">
                                                        {/* <Download strokeWidth={3} size={15} className="text-white"/> */}
                    ...
                    <div className="w-full h-full md:hidden pb-4">
                        {data.kitsFinishing && data.kitsFinishing.length > 1 &&
                            <SwiperCarouselKitsFinishing kits_finishing={data.kitsFinishing} kits_finishing_preview={data.kitsFinishingPreview??[]}/>
                        }    
                    </div>
