...
export default function Contact({ oneBrand, aboutHref = '/about', executeRecaptcha }: ContactProps) {
  ...
  const onSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (!executeRecaptcha) throw new Error('reCAPTCHA is not available.')
              ...
              <>
                {oneBrand.maps ? (
                  <div style={styles.mapFrame}>
                    {mapLoading && <div style={styles.mapLoading}>Loading map...</div>}
                    <iframe
