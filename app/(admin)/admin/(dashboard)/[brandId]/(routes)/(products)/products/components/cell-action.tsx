      ...
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          {data.isKits &&
            <>
              <DropdownMenuItem
                onClick={() => router.push(`${process.env.NEXT_PUBLIC_ADMIN_FOLDER_URL}/${params.brandId}/products/${data.id}/kitsfinishing`)}
              >
                <BookIcon className="mr-2 h-4 w-4" /> Set Kits Finishing
              </DropdownMenuItem>
              <DropdownMenuItem
                onClick={() => router.push(`${process.env.NEXT_PUBLIC_ADMIN_FOLDER_URL}/${params.brandId}/products/${data.id}/productusedinkits`)}
              >
                <BookIcon className="mr-2 h-4 w-4" /> Set Products Used in Kits
              </DropdownMenuItem>
            </>
          }
