                                ...
                                <div style={{ display: "flex", flexWrap: "wrap", gap: "0.5rem" }}>
                                    ...
                                    {prod_sub_cat.length !== 0 &&
                                        prod_sub_cat.map((subcategory, index) => (
                                            <a
                                                href={`/sbaudience/${prod_cat[0]?.slug.toLowerCase().replace(/\s+/g, '-')}/${subcategory.slug.toLowerCase().replace(/\s+/g, '-')}`} key={index}
                                            >
                                    ...
                                    {prod_sub_sub_cat.length !== 0 &&
                                        prod_sub_sub_cat.map((subsubcategory, index) => (
                                            <a
                                                href={`/sbaudience/${prod_cat[0]?.slug.toLowerCase().replace(/\s+/g, '-')}/${prod_sub_cat[0]?.slug.toLowerCase().replace(/\s+/g, '-')}/${subsubcategory.slug.toLowerCase().replace(/\s+/g, '-')}`} key={index}
                                            >
