...
//                           <Link href={brand === 'sbaudience' ? `/sbaudience/products/${item.slug}`: `/products/${item.slug}`}>Learn More</Link>
//                         </Button>
//                       </div>
//                     </div>
//                 </div>
...
//                 <div className={`absolute inset-x-0 bottom-0 xl:px-16 xl:py-8 lg:px-12 lg:py-6 px-8 py-4 h-fit flex items-end ${'bg-linear-to-r from-white/80 to-white/0'}`}>
//                     <div className="grid gap-0 grid-cols-1 w-fit">
//                       <h3 className="text-left font-bold xl:text-5xl text-3xl text-foreground pb-4 lg:text-white">
//                         {item.name}
//                       </h3>
