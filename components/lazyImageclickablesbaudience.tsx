...
export const LazyImageClickableSBAudience = ({ src, alt, width, height, classname, testid }: { src: string; alt: string; width: number; height: number; classname: string; testid?: string }) => {
